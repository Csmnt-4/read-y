...
class _BookListState extends State<BookList> {
  ...
  Widget build(BuildContext context) {
    return (widget.century != null && widget.genres != null) ? Scaffold(
      appBar: appBar(
      ...
      body: Container(
        ...
        child: ListView(
          children: [
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: roundedContainer(
                                Text("${widget.century.first} - ${widget.century.last} столетие; Жанр: ${widget.genres[0]} и т.д.",
              ...
              FutureBuilder(
                future: fetchBooks(
                    widget.genres, widget.trueCentury, widget.percent, widget.uid),
                    ...
                    return Center(
                      child: Column(
                        children: [
                          Padding(
                            padding:
                                const EdgeInsets.only(top: 100.0, bottom: 200.0),
                            child: Text(
                              'Книг по вашим\nфильтрам нет...',
                              style: h3White,
                            ),
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.of(context).push(MaterialPageRoute(builder: (context) => FilteredBookList(title: "${widget.century.first} - ${widget.century.last} столетие; Жанр: ${widget.genres[0]} и т.д.", books: books)));
                          },
                          style: ElevatedButton.styleFrom(
                            primary: cPu,
                            shape: RoundedRectangleBorder(
